...
**File:** `sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql`  
**Type:** database_schema  
**Detected at:** 2025-11-07T08:00:01.142276  
...
1. **Analyze the change:**
   - Read the full file: `sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql`
...
```sql
-- PostgreSQL check
SELECT COUNT(*) FROM team_tools WHERE file_path LIKE '%sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql%';
-- Should return > 0

-- Neo4j check
MATCH (n) WHERE n.file_path CONTAINS 'sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql' RETURN count(n);
-- Should return > 0
```
...
curl -X POST http://localhost:6333/collections/destiny-team-framework-master/points/scroll \
  ...
  -d '{"filter": {"must": [{"key": "file_path", "match": {"text": "sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql"}}]}}' | jq '.result.points | length'
# Should return > 0

# Redis check
docker exec kg-redis redis-cli KEYS "*pg_20251107_071031_COMMIT_71fe32a_documentation*"
# Should return > 0
```
...
**Task:** Propagate sql/realtime_updates/pg_20251107_071031_COMMIT_71fe32a_documentation.sql to databases  
