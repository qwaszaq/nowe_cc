...
**File:** `sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher`  
**Type:** knowledge_graph  
**Detected at:** 2025-11-05T11:00:00.522922  

**File Preview:**
```
// Create document node
MERGE (d:Document {file_path: 'TODO_WEEK2.md'})
SET d.title = '📋 TODO - Week 2 Priorities',
...
1. **Analyze the change:**
   - Read the full file: `sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher`
...
```sql
-- PostgreSQL check
SELECT COUNT(*) FROM team_tools WHERE file_path LIKE '%sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher%';
-- Should return > 0

-- Neo4j check
MATCH (n) WHERE n.file_path CONTAINS 'sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher' RETURN count(n);
-- Should return > 0
```
...
curl -X POST http://localhost:6333/collections/destiny-team-framework-master/points/scroll \
  ...
  -d '{"filter": {"must": [{"key": "file_path", "match": {"text": "sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher"}}]}}' | jq '.result.points | length'
# Should return > 0

# Redis check
docker exec kg-redis redis-cli KEYS "*neo4j_20251105_104647_TODO_WEEK2*"
# Should return > 0
```
...
**Task:** Propagate sql/realtime_updates/neo4j_20251105_104647_TODO_WEEK2.cypher to databases  
